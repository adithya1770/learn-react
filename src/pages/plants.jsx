...
function Plants(){
    ...
    return(
        ...
        <img src="https://cdn-icons-png.flaticon.com/512/732/732090.png" alt="https://w7.pngwing.com/pngs/1022/900/png-transparent-open-opensource-source-logos-and-brands-line-filled-icon.png" className="h-10 w-10 absolute right-5 top-36" />
            ...
            <input type="text" id="plantName" name="plantName" className="placeholder-black rounded-3xl w-80 h-10 text-center border-2 border-black hover:shadow-2xl" placeholder="Enter Plant Name" onChange={(e) => setplantName(e.target.value)}/>
            <button onClick={plantData} className="h-10 w-40 bg-black text-white rounded-3xl border-2 border-white hover:text-black hover:bg-white">Find</button>
            ...
            <p className="text-black inline-block absolute bottom-44 w-160 right-80 mt-2">{ details }</p>
