...
function Home(){
    ...
    return(
        <div>
        <div className="poppins-bold absolute lg:bottom-5 lg:pl-160 pl-6 bottom-52">
        ...
        <div className='h-24 w-24 bg-white absolute lg:left-170 rounded-2xl top-6 left-36 '>
